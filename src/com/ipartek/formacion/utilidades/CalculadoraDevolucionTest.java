...
public class CalculadoraDevolucionTest {
	...
	//El caso en el que te devuelven un billete de casa
	@Test
	public void importeNoExactoDecimales() throws Exception {
		int[] vueltas = CalculadoraDevolucion.vueltas( 1, 889.88f);
